  ...
  return {
    visitor: {
      JSXOpeningElement(path) {
        ...
        const layoutAttributes = attributes.filter(attribute => isLayoutAttribute(attribute));
        ...
        const inlineStyleAttributes = attributes.filter(attribute => isInlineStyleAttribute(attribute));
